          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="w-full flex flex-col">
                <p className="text-sm ms-auto text-blue-300 mb-2">
                  <Link href={"/auth/confirm-your-email"}>Forget Password?</Link>
                </p>
                {/* Submit Button */}
                <Button
                  ...
                  type="submit"
                >
                  {form.formState.isLoading && <Loader2 className="animate-spin h-4 w-4" />}
                  Login
                </Button>
              </div>

              {errorMsg && (
                <p className="text-center text-sm text-red-500">Incorrect email or password</p>
              )}
            </form>
            <div className="flex mt-2 mx-auto w-fit">
              <p className="me-1">You dont have an account?</p>
              <Link className="text-blue-300" href={"/auth/register"}>
                Register...
              </Link>
            </div>
          </Form>
